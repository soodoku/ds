...
* Know the assumptions are behind the formulas.
...
* For average proximity, one common cure is to square each number 
...
* Square root of the sum of squares and the average of absolute values is not the same
